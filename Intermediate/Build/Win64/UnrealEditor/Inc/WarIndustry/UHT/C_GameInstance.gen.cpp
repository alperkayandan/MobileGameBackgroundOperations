...
const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UC_GameInstance_Statics::InterfaceParams[] = {
	{ Z_Construct_UClass_USaveInterface_NoRegister, (int32)VTABLE_OFFSET(UC_GameInstance, ISaveInterface), false },  // 2271407248
};
...
struct Z_CompiledInDeferFile_FID_Users_alper_Documents_Unreal_Projects_WarIndustry_Source_WarIndustry_Public_C_GameInstance_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UC_GameInstance, UC_GameInstance::StaticClass, TEXT("UC_GameInstance"), &Z_Registration_Info_UClass_UC_GameInstance, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UC_GameInstance), 1740576523U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_alper_Documents_Unreal_Projects_WarIndustry_Source_WarIndustry_Public_C_GameInstance_h_3382266630(TEXT("/Script/WarIndustry"),
